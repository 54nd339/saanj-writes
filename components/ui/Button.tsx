...
const sizes = {
  ...
  md: 'px-4 sm:px-6 py-2 sm:py-3 text-xs',
  lg: 'px-6 sm:px-8 py-3 sm:py-4 text-sm',
};
...
export function Button({
  ...
  const baseStyles = cn(
    'inline-flex items-center justify-center gap-1.5 sm:gap-2 font-mono uppercase tracking-wider rounded-lg transition-all duration-300',
